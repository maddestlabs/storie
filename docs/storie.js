...
// include: /tmp/tmpucc87hgn.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = '/workspaces/Storie/docs/storie.data';
      var REMOTE_PACKAGE_BASE = 'storie.data';
...
Module['FS_createPath']("/", "assets", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_/workspaces/Storie/docs/storie.data');
      }
      Module['addRunDependency']('datafile_/workspaces/Storie/docs/storie.data');
    ...
    loadPackage({"files": [{"filename": "/assets/AnomalyMono-Powerline.otf", "start": 0, "end": 971220}], "remote_package_size": 971220});

  })();

// end include: /tmp/tmpucc87hgn.js
// include: /tmp/tmpn_6ye0jj.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpn_6ye0jj.js
// include: /tmp/tmp6yywdhm5.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp6yywdhm5.js
...
var _setWaitingForGist = Module['_setWaitingForGist'] = makeInvalidEarlyAccess('_setWaitingForGist');
var _loadMarkdownFromJS = Module['_loadMarkdownFromJS'] = makeInvalidEarlyAccess('_loadMarkdownFromJS');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['setWaitingForGist'] != 'undefined', 'missing Wasm export: setWaitingForGist');
  assert(typeof wasmExports['loadMarkdownFromJS'] != 'undefined', 'missing Wasm export: loadMarkdownFromJS');
  ...
  _setWaitingForGist = Module['_setWaitingForGist'] = createExportWrapper('setWaitingForGist', 0);
  _loadMarkdownFromJS = Module['_loadMarkdownFromJS'] = createExportWrapper('loadMarkdownFromJS', 1);
