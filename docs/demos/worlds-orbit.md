...
worlds.enable();
worlds.camera.setPosition(0, 0, 200);
worlds.camera.setEaseSpeed(0.05, 0.08);
console.log('✓ 3D Canvas enable requested');
console.log('Total sections:', worlds.getSectionCount());
...
if (worlds.getSectionCount() < 4) return;
