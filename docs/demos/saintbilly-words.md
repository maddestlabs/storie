...
# cross-1 {x: -13.6, y: 99, rotate-z: -90, scale: 1.168, timed: "25400ms"}
...
# cross-7 {x: 0, y: 94.5, rotate-z: 90, scale: 0.997, timed: "28700ms"}
...
# cross-108 {x: 30.6, y: 40.5, scale: 1.154, timed: "90650ms"}

a

# cross-109 {x: 34, y: 40.5, scale: 0.819, timed: "90853ms"}

strange

# cross-110 {x: 37.4, y: 40.5, scale: 1.246, timed: "91055ms"}
...
# cross-114 {x: -69.7, y: 36, scale: 1.077, timed: "92865ms"}

his

# cross-115 {x: -66.3, y: 36, scale: 1.187, timed: "93068ms"}

side

# cross-116 {x: -62.9, y: 36, scale: 1.169, timed: "93270ms"}

and

# cross-117 {x: -59.5, y: 36, rotate-z: 90, scale: 1.107, timed: "93473ms"}

sword|=====>

# cross-118 {x: -56.1, y: 36, scale: 0.944, timed: "93675ms"}

in

# cross-119 {x: -52.7, y: 36, scale: 1.35, timed: "94878ms"}

hand

# cross-120 {x: -8.5, y: 36, scale: 0.892, timed: "95080ms"}
...
# cross-138 {x: -32.3, y: 31.5, scale: 0.846, timed: "103800ms"}

woke

# cross-139 {x: -28.9, y: 31.5, scale: 0.922, timed: "104000ms"}

the

# cross-140 {x: -25.5, y: 31.5, rotate-z: 90, scale: 1.331, timed: "104060ms"}
...
# cross-164 {x: 17, y: 27, rotate-z: 90, scale: 0.875, timed: "113500ms"}

this

# cross-165 {x: 20.4, y: 27, rotate-z: -90, scale: 0.856, timed: "113800ms"}
...
# cross-249 {x: -62.9, y: 4.5, rotate-z: 90, scale: 1.026, timed: "163814ms"}
...
function buildTimedSections() {
  ...
  state.timedSections = all
    .filter((section) => section.timedMs !== undefined && !section.sectionId?.startsWith('cross-'))
    .sort((a, b) => a.timedMs - b.timedMs);
  state.cameraSections = all
