...
worlds.camera.focusOnSection(2, 80);
```
...
```javascript on:enter
worlds.camera.focusOnSection(3, 80);
```
...
```javascript on:enter
worlds.camera.focusOnSection(4, 80);
```
...
worlds.camera.setPosition(0, 0, 150);
worlds.camera.setRotation(0, 0, 0);
```
...
```javascript on:enter
worlds.camera.focusOnSection(5, 120);
```
...
```javascript on:enter
worlds.camera.focusOnSection(7, 120);
```
...
```javascript on:enter
worlds.camera.focusOnSection(8, 120);
```
...
```javascript on:enter
worlds.camera.focusOnSection(9, 120);
```
...
```javascript on:enter
worlds.camera.focusOnSection(10, 120);
```
...
const pos = worlds.camera.getPosition();
const rot = worlds.camera.getRotation();

// Movement
if (key.down('ArrowUp')) {
  worlds.camera.setPosition(pos.x, pos.y - speed * getDelta(), pos.z);
}
...
if (key.down('a') || key.down('A')) {
  worlds.camera.setRotation(rot.x, rot.y - rotSpeed * getDelta(), rot.z);
}
