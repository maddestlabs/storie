...
import type { Vec3, Transform3D, Camera3D, Section3DLayout, Canvas3DConfig } from './canvas3d-types.js';
...
export function mat4Multiply(a: Float32Array, b: Float32Array): Float32Array {
  ...
  // Compatible with WebGPU/WGSL convention: clipPos = M * vec4(pos, 1)
  const out = new Float32Array(16);
...
/**
 * Create a view matrix (inverse of camera transform)
 */
export function mat4LookAt(eye: Vec3, target: Vec3, up: Vec3 = { x: 0, y: 1, z: 0 }): Float32Array {
...
/**
 * Get default 3D config
 */
export function getDefaultCanvas3DConfig(): Canvas3DConfig {
  return {
